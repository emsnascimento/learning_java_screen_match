...
import src.screenmatch.calculos.CalculadoraDeTempo;
import src.screenmatch.calculos.FiltroRecomendacao;
import src.screenmatch.modelos.Episodio;
...
public class Principal {
	public static void main(String[] args) {
		...
		System.out.println(listaDeFilmes.contains(filmeDoPaulo));
		System.out.println(listaDeFilmes.contains("Dogville"));
